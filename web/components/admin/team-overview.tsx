...
import { FileText, UserRound, TrendingUp, Trophy, ChevronDown, BarChart2, ChevronRight, BadgeCheck, CalendarDays } from 'lucide-react'
...
export function TeamOverview({
  ...
  const monthStats = useMemo(() =>
    computeStats(agents, (d) => d.startsWith(selectedMonth), metric),
    [agents, selectedMonth, metric]
  )
  ...
  const csvRows = yearStats.map(({ agent, listings, content, contacts }) => ({
    name: agent.name,
    email: agent.email,
    role: agent.role,
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none rounded-lg border border-neutral-200 bg-white px-3 py-1.5 pr-8 text-sm text-neutral-700 focus:outline-none focus:ring-2 focus:ring-neutral-300"
              >
                {months.map((m) => (
            ...
            {isAdmin && <ExportCsvButton rows={csvRows} month={monthLabel(selectedMonth)} />}
          </div>
        )}
      </div>
          ...
          <CardContent className="pt-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500">Imm. nel mese</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500">Venduti nel mese</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-base">
              ...
              Classifica — {monthLabel(selectedMonth)}
            </CardTitle>
          </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-base">
            ...
            Dettaglio agenti — {monthLabel(selectedMonth)}
